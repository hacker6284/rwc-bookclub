# Real-World Cryptography — Supplemental Pack

Source: David Wong, *Real-World Cryptography*. Outline from authoritative `chapter_headings.json`.
Videos placed from **transcript content**, not title keywords. Layering: Computerphile → 3Blue1Brown → Sebastian Lague → Ben Eater → Numberphile family.
